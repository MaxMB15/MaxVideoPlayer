...
function ContentTypeBadge({ type }: { type: string }) {
  ...
  const label =
    normalized === "live" ? "LIVE" : normalized === "movie" ? "MOVIE" : "SERIES";
  return (
            ...
            >
                ...
                {entry.channelLogo ? (
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.textContent = entry.channelName.charAt(0).toUpperCase();
                        parent.classList.add("text-sm", "font-semibold", "text-muted-foreground");
                      }
                    }}
                  />
                ) : (
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="font-medium text-sm truncate">{entry.channelName}</span>
